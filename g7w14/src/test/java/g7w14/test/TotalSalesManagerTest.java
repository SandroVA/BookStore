...
public class TotalSalesManagerTest {
	
	@Inject
	CalendarBean calendar;
	@Inject
	TotalSalesManager manager;
	@Inject
	TotalSalesBean bean;
	@Deployment
	public static WebArchive deploy() {
		return ShrinkWrap
				...
				.addAsManifestResource(
						...
						"context.xml")
				.addClasses(CalendarBean.class, TotalSalesManager.class, TotalSalesBean.class);
	}
	...
	public void testTotal() throws SQLException {
		...
		ArrayList<TotalSalesBean> results = null;
		results= manager.getTotalSales();
